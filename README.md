...
```javascript
import increwmean from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-ewmean@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-ewmean/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-incr-ewmean/actions/workflows/test.yml?query=branch:v0.2.3
